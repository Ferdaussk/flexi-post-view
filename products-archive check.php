<?php
/**
 * Plugin Name: Posts Archive
 * Description: Posts Archive plugin is an post single page for enables customer to have a quick look of post without visiting post page.
* Plugin URI: https://bestwpdeveloper.com/shop/
* Version: 1.0
* Author: Best WP Developer
* Author URI: https://bestwpdeveloper.com/
* Text Domain: posts-archive
*/
