...
/**
 * V4
 * Post single page design instructions [-------------------------
 */
?>
...
11. Categories 
12. Add a select option to select variable posts [Only for variable posts]
...
15. Post description and reviews (This two are in one div) must be like this. You can't add or remove anything from here. It's a tab. 
...
16. This is related posts. Design it as your wish and also you can add carousel.
...
12. This option is mising here also. Check it with add a variable post. It's for variable post only. Design it to follow the default html tag from form tag.
Remember that, When post is a variable post then will show the option 12 and others time will show the 14 option. So, you need to two type design here.
...
15. First install the plugin in localhost and from dashboard enable that then view a post single page. Then find the tab section "Description" and "Reviews". In review tab see all content and design it well-oriented. 
Note: After review tab design add some reviews. Secound, Check all css conflict issue with wp default themes.

@Plugin download from here (https://github.com/Ferdaussk/flexi-post-view.git)
@See all previous instructions from here (https://github.com/Ferdaussk/flexi-post-view/blob/master/Post%20single%20page%20design%20instructions.php) 
