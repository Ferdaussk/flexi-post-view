...
function flpvi_relpro_productsaleprice_hover_size_fld(){
  ...
  $slider_value = get_option('flpvi-relpro-productsaleprice-hover-size-control', $default_value); // Get the saved value or use the default if not set.
  ?>
  <div class="noUi_Slider" id="flpvi-relpro-productsaleprice-hover-size-control"></div>
  <input type="hidden" name="flpvi-relpro-productsaleprice-hover-size-control" id="flpvi-nouislider-value" value="<?php echo esc_attr($slider_value); ?>" />
  <div class="noUi_Slider_Tooltips" id="flpvi-nouislider-tooltips"></div>
  <script>
    // Initialize the noUiSlider
    document.addEventListener('DOMContentLoaded', function() {
      var slider = document.getElementById('flpvi-relpro-productsaleprice-hover-size-control');
...
// function flpvi_relpro_productsaleprice_hover_size_fld() {
// 	global $flpvi_relpro_productsaleprice_hover_size_value;
//   echo '<input type="text" id="flpvi-relpro-productsaleprice-hover-size" name="flpvi-relpro-productsaleprice-hover-size-control" value="'.$flpvi_relpro_productsaleprice_hover_size_value.'"  placeholder="0px">';
