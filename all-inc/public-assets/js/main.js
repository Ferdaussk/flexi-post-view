...
// Quentity
  ...
  let minus_button = commnClass.querySelector('.flpvi-minusx');
  let plus_button = commnClass.querySelector('.flpvi-plusx');
  let input_button = commnClass.querySelector('.flpvi-quentity-box input');
  let a = 1;
...
const mainWrap = document.querySelectorAll('.flpvi-single-post-main');
