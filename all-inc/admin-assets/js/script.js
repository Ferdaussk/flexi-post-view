...
//   const active = document.querySelector('.flpvi_active');
//   if(active){
//     active.classList.remove('flpvi_active')
//   }
//   event.target.className = "flpvi_active";
// }
...
// This is for dashboard tab (New js)
  ...
  const acc1Items = document.querySelectorAll('.flpvi_acc1_view1, .flpvi_acc1_view2');
  ...
  const acc2Items = document.querySelectorAll('.flpvi_acc2_view1, .flpvi_acc2_view2, .flpvi_acc2_view3');
